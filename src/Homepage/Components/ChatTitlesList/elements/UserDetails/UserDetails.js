...
import ToggleUserMenu from "../ToggleUserMenu/ToggleUserMenu";
...
const UserDetails = () => {
  ...
  useEffect(() => {
    document.addEventListener("click", (event) => {
      if (event.target.getAttribute("options") === "user-toggle") {
        return;
      }
  ...
  return (
    <div className="user-details">
      ...
      <div className="user-settings">
        <div className="user-settings-name">Alisher</div>

        <div className="user-setting-number">+998 91 123 45 67</div>
      </div>
